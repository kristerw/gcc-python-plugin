...
def generate_cfg():
    ...
    getsettable = PyGetSetDefTable('PyGccCfg_getset_table',
                                   [PyGetSetDef('basic_blocks',
                                    ...
                                    PyGetSetDef('inverted_post_order',
                                                'PyGccCfg_get_inverted_post_order',
                                                None,
                                                'The list of gcc.BasicBlock in inverted post order'),
                                    PyGetSetDef('reverse_post_order',
                                                'PyGccCfg_get_reverse_post_order',
                                                None,
                                                'The list of gcc.BasicBlock in reverse post order'),
                                    PyGetSetDef('entry',
